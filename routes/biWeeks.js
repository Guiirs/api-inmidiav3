...
const biWeekController = require('../controllers/biWeekController');
const biWeekValidator = require('../validators/biWeekValidator');
...
router.post(
    '/',
    authMiddleware,
    adminAuthMiddleware, // Apenas administradores
