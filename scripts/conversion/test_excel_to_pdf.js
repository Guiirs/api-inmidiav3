...
async function convertExcelToPDF() {
  ...
  // script foi movido para scripts/conversion -> precisar subir mais um nível para chegar ao root BECKEND
  ...
  // ajusta require após mover o script para scripts/conversion
...
// Export the main function so it can be invoked programmatically.
module.exports = convertExcelToPDF;

// If executed directly from the CLI, run and exit with proper code.
