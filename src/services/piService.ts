...
import User from '../models/User'; // Para dados do gerador do PDF
import Empresa from '../models/Empresa'; // Para dados do gerador do PDF
import Placa from '../models/Placa';
import Aluguel from '../models/Aluguel'; // Para criar aluguéis automaticamente
import AppError from '../utils/AppError';
import logger from '../config/logger';
import pdfService from './pdfService'; // Importa o novo serviço de PDF
import PeriodService from './periodService'; // [PERÍODO UNIFICADO] Service centralizado
